...
public abstract class DefaultCreateClass {
     ...
     * converting to a class file will cause the class to be frozen
     *
     * @param name
     * @param cts
     */
    ...
    /**
     * name: package name+class name.eg:java.lang.String
     * returning a byte array will cause the class to be frozen
     *
     * @param name
     * @param cts
     */
    public static byte[] createWithByte(String name, List<Field> cts) throws CannotCompileException, IOException {
        ClassPool pool = ClassPool.getDefault();
        CtClass ctClass = pool.makeClass(name);
     ...
     * @param cts
     */
    public static Class createWithClz(String name, List<Field> cts) throws CannotCompileException, IOException {
        ClassPool pool = ClassPool.getDefault();
        CtClass ctClass = pool.makeClass(name);
